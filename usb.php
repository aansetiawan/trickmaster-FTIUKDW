...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<div id="wrapper">
		...
		<ul id="category_nav">
			...
			<li><a href="stick.php">Stick</a></li>
			<li><a href="speaker.php">	Speaker</a></li>
			<li><a href="usb.php"><strong>USB Port</strong></a></li>
			...
			<a href="#">
				...
				<form action="prosesbeli.php" method="post">
					<img src="gambar/usbport1.jpg" alt="gambar1">
			...
			<a href="#">
				<div class="itembox">
				<form action="prosesbeli.php" method="post">
					<img src="gambar/usbport2.jpg" alt="gambar1">
					<p><input type="submit" name="1" value="Beli"> <br/>Power Bank <br/>
					Rp 100.000
					</p>
				</form>
			...
			<a href="#">
				<div class="itembox">
				<form action="prosesbeli.php" method="post">
					<img src="gambar/usbport3.jpg" alt="gambar1">
					<p><input type="submit" name="1" value="Beli"> <br/>Power Bank <br/>
					Rp 100.000
					</p>
				</form>
